                 ...
                 <?php $__env->slot('toolbar', null, []); ?> 
                  ...
                  <div class="input-group flex-nowrap">
                    ...
                    <?php if(Auth::user()->can('create_subcategories')): ?>
                      <button type="button" class="btn btn-primary" data-crud-id="<?php echo e(0); ?>" title="<?php echo e(__('messages.create')); ?> <?php echo e(__('category.sub_category')); ?>"><i class="fas fa-plus-circle me-2"></i><?php echo e(__('messages.new')); ?></button>
                    <?php endif; ?>
...
<?php endif; ?>
    ...
    <div data-render="app">
        <category-form-offcanvas
            ...
            create-title="<?php echo e(__('messages.create')); ?><?php echo e(__('category.new')); ?> <?php echo e(__('category.singular_title')); ?>" edit-title="<?php echo e(__('messages.edit')); ?><?php echo e(__('category.sub_category')); ?>"
            create-nested-title="<?php echo e(__('category.new')); ?> <?php echo e(__('category.sub_category')); ?> " edit-nested-title="<?php echo e(__('messages.edit')); ?> <?php echo e(__('category.sub_category')); ?>"
            :category-id="<?php echo e(isset($category->id) ? $category->id : 0); ?>"
            ></category-form-offcanvas>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startPush('after-scripts'); ?>
    ...
    const columns = [
            ...
            { data: 'mainCategory.name', name: 'mainCategory.name', title: "<?php echo e(__('category.lbl_category')); ?>" ,width: '15%', searchable: false, orderable: false, },
            ...
            { data: 'status', name: 'status',  searchable: true, title: "<?php echo e(__('category.lbl_status')); ?>" ,width: '5%' },
        ]
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            initDatatable({
                url: '<?php echo e(route("backend.products-categories.index_nested_data")); ?>',
                finalColumns,
                orderColumn: [[ 4, "desc" ]],
                advanceFilter: () => {
                  return {
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/city2tec/project/Modules/Product/Resources/views/backend/category/index_nested_datatable.blade.php ENDPATH**/ ?>