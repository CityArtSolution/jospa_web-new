...
<div class="position-relative overflow-hidden shadow" style="height: 300px;width: 100%;">
    ...
    <div class="position-absolute bottom-0 start-0 w-100 p-3" style="background: rgba(0, 0, 0, 0.4);height: 41%;">
      ...
      <div class="d-flex justify-content-between align-items-center mt-2" style="font-size: 16px;">
          ...
          <a class="deta" href="<?php echo e(route('home.details', $package_id)); ?>" style="    background: #BF9456;padding: 6px;width: 27%;text-align: center;border-radius: 17px;color: white;"> <?php echo e(__('messagess.details')); ?></a>
      </div>

    </div>
</div><?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\resources\views/components/frontend/package-card.blade.php ENDPATH**/ ?>