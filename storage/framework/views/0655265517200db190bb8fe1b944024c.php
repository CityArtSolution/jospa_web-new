        ...
        <?php $__currentLoopData = $allCat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                <a href="<?php echo e(url('services/category/' . $Cat->id)); ?>" style="text-decoration-line: none;">
                    <div class="galary" 
                                style="background-image: url('<?php echo e($Cat->av2 ? asset($Cat->av2) : asset('images/av3.webp')); ?>');"
                                background-size: cover; 
                                background-position: center; 
                                height: 200px; 
                                border-radius: 18px !important;
                                <?php if($Cat->id == $category->id): ?> border: 4px #BF9456 solid; <?php endif; ?>">
...
</html><?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\Modules/rontend\Resources/views/category-details.blade.php ENDPATH**/ ?>