...
<section class="py-5">
    <div class="container"  style="padding: 0 5rem;">
        <h2 class="mb-5 mt-3 text-center" style="font-size: 42px;background: linear-gradient(90deg, #CF9233, #212121);-webkit-background-clip: text;-webkit-text-fill-color: transparent;font-weight: bold;">
            <?php echo e(__('messagess.3naya_product')); ?>
        ...
        <a href="<?php echo e(route('frontend.Shop')); ?>" class="more-btn">
            ...
            <p style="color:white;font-size: 16px;margin: 0 13px;"><?php echo e(__('messagess.learn_more')); ?></p>
        </a>
        <?php else: ?>
            <div class="text-center py-5">
                <p class="text-muted"><?php echo e(__('messagess.no_product')); ?></p>
            </div>
        <?php endif; ?>
    </div>
</section>
...
<?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\resources\views/components/frontend/product-section.blade.php ENDPATH**/ ?>