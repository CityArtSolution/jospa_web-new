...
<?php endif; ?>
        ...
        <p style="text-align:center;margin-top:20px;">
            ...
            <a href="<?php echo e(route('signup')); ?>" style="color:#BF9456;font-weight:500;text-decoration:none;"><?php echo e(__('auth.signup')); ?></a>
        </p>
    </div>
</div>
...
<?php echo $__env->make('frontend::layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\resources\views/components/frontend/auth/signin.blade.php ENDPATH**/ ?>