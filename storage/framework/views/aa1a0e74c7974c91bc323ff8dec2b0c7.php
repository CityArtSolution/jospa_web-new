...
<body>
    ...
    <div class="col-lg-8 mb-4">
      <div class="rounded p-3" style="background: white;">
        <h5 style="padding: 10px;color: #CF9233;font-weight: bold;font-size: 21px;" class="text-center mb-3"><?php echo e(__('profile.my_transactions')); ?></h5>
    ...
    <div class="col-lg-4">
      <div class="payment-box shadow-sm">
        ...
        <div class="row g-3 text-center">
          <div class="col-6">
            <img src="<?php echo e(asset('images/icons/visa.png')); ?>" alt="Visa" class="img-fluid  rounded p-3" style="background: #f5f5f5;">
          </div>
          <div class="col-6">
            <img src="<?php echo e(asset('images/icons/mada.png')); ?>" alt="Mada" class="img-fluid  rounded p-3" style="background: #f5f5f5;">
          </div>
          <div class="col-6">
            <img src="<?php echo e(asset('images/icons/tamara.png')); ?>" alt="تمارا" class="img-fluid border rounded p-3" style="background: #f5f5f5;">
          </div>
          <div class="col-6">
            <img src="<?php echo e(asset('images/icons/tabby.png')); ?>" alt="tabby" class="img-fluid  rounded p-3" style="background: #f5f5f5;">
          </div>
        </div>
      </div>
    </div>
...
<?php /**PATH /home/city2tec/project/resources/views/components/frontend/auth/profile.blade.php ENDPATH**/ ?>