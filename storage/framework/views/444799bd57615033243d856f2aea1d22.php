...
<section class="position-relative" style="height: calc(100vh - 200px);">
    ...
    <div style="margin-top: -60px !important;">
        <a href="<?php echo e(route('gift.page')); ?>" class="btn b_h text-white d-flex align-items-center justify-content-center gap-2 mx-auto px-3 px-md-5 py-3 fs-5 fs-md-5 gift-btn-responsive" style="z-index: 9;position: relative;border-radius: 30px;border:1px solid #c69b6d;background:white;width: 349.775px;height: 54px;">
            <span class="iconify" data-icon="basil:present-outline" data-width="32" data-height="32" style="color:#c69b6d;"></span>
            <span class="text-center" style="font-size: 22.4px;white-space: nowrap;color:#c69b6d;"><?php echo e(__('messagess.gift_line_4')); ?></span>
        </a> 
    </div>
...
<?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\resources\views/components/frontend/gift-section.blade.php ENDPATH**/ ?>