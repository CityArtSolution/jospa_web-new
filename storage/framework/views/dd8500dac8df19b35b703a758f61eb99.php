...
">
    <div style="
        ...
        z-index:10;
    ">
        <h2 style="text-align:center;margin-bottom:20px;font-size:24px;font-weight:bold;"><?php echo e(__('auth.singup')); ?></h2>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('signup.store')); ?>" style="display:flex;flex-direction:column;">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-top:15px;display: flex;">
                ...
                " onmouseover="this.style.transform='translateY(-2px)';"
                   onmouseout="this.style.transform='none';">
                    <?php echo e(__('auth.singup_button')); ?>
...
<?php echo $__env->make('frontend::layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\resources\views/components/frontend/auth/signup.blade.php ENDPATH**/ ?>