...
<body class="<?php echo e(auth()->user()->user_setting['theme_scheme'] ?? ''); ?>">
    <div class="WheelOfFortune">
        <div class="Wheel"> 
            ...
            <button class="hid-wheel" id="spin-btn"><?php echo e(__('messagess.spin_the_wheel')); ?></button>
        </div>
    </div>
...
<?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\Modules/rontend\Resources/views/layouts/master.blade.php ENDPATH**/ ?>