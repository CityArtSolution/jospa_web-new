...
<?php unset($__defined_vars); ?>
        ...
        <div class="row gx-4 gy-4"> 
            ...
            <div class="col-lg-8">
                <div class="panel mb-4">
                    <h5><i class="fa-solid fa-location-dot" style="margin: 0 6px;"></i> <?php echo e(__('messagess.service_location')); ?></h5>
                    <div class="row g-2 align-items-start" style="flex-direction: column;">
                        <div class="col-12 col-md-4">
                            <div class="form-check" style="margin: 20px;">
                                <input class="form-check-input" type="radio" name="place" id="branchHome" checked>
                                <label class="form-check-label muted" for="branchHome"> <?php echo e(__('messagess.main_branch')); ?></label>
                            </div>  
                        </div>
                        <div class="col-12 col-md-8" style="margin: 20px;">  
                            <textarea class="form-control" rows="2" disabled>
                                +964 567 578 567
                                <?php echo e(__('messagess.address_jeddah')); ?>
                ...
                <div class="panel">
                    <h5><i class="fa-solid fa-credit-card" style="margin: 0 6px;"></i> <?php echo e(__('booking.lbl_payment')); ?></h5>
                    ...
                    <div class="method" data-method="card" tabindex="0">
                        ...
                        <!-- card fields -->
                        <div class="card-fields mt-4 mb-3 px-2">
                            <lable class="l-payment"><?php echo e(__('messagess.card_number')); ?>:</lable>
                            <br>
                            <input class="form-control mb-2"  disabled onclicl="alert('قم بالضغط علي تاكيد الدفع للانتقال لبوابة الدفع')">
                            <div class="row g-2">
                                <lable class="l-payment"><?php echo e(__('messagess.expiration_date')); ?>:</lable>
                                <br>
                                <div class="col-4">
                                    <input class="form-control" disabled onclicl="alert('قم بالضغط علي تاكيد الدفع للانتقال لبوابة الدفع')" placeholder="<?php echo e(__('messagess.month')); ?>">
                                </div>
                                <div class="col-4">
                                    <input class="form-control" disabled onclicl="alert('قم بالضغط علي تاكيد الدفع للانتقال لبوابة الدفع')" placeholder="<?php echo e(__('messagess.year')); ?>">
                                </div>
                                <div class="col-4">
                                    <input class="form-control" disabled onclicl="alert('قم بالضغط علي تاكيد الدفع للانتقال لبوابة الدفع')" placeholder="CVV">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- METHOD: points -->
                    <div class="method d-flex" style="gap: 20px;" data-method="points" tabindex="0">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="paymentMethod" value="points">
                        </div>
                        <div class="flex-fill muted"> <?php echo e(__('messagess.loyalty_points')); ?> </div>
                    </div>

                    <!-- METHOD: wallet -->
                    <div class="method d-flex" style="gap: 20px;" data-method="wallet" tabindex="0">
                        <div class="form-check form-check-inline">
            ...
            <div class="col-lg-4">
                <div class="summary-card"> 
                    ...
                    <div class="coupon-input">
                        ...
                        <button class="apply-btn" type="button" onclick="checkInvoiceCoupon(this)" id="applyCoupon"><?php echo e(__('messagess.apply')); ?></button>
                    </div>
  ...
  </form><?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\resources\views/components/frontend/payment.blade.php ENDPATH**/ ?>