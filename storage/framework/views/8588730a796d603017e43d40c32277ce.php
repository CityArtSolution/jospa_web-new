...
<link href="https://fonts.googleapis.com/css2?family=Zain:ital,wght@0,200;0,300;0,400;0,700;0,800;0,900;1,300;1,400&display=swap" rel="stylesheet">
  <style>
   ...
   <style>
    body {
      background: url('images/pages/Rectangle 42623.png') no-repeat center center/cover !important;
    ...
    .coupon-section::before {
        ...
        width: 100%;
        height: 100%;
        background-image: url('<?php echo e(asset("images/pages/couponbg.jpg")); ?>');
        background-size: cover;
        background-position: top;
        filter: blur(8px);
        z-index: -2; /* تحت كل العناصر */
    }
    ...
    .coupon-section::after {
        ...
        width: 100%;
        height: 100%;
        background-color: rgba(0,0,0,0.4); /* الطبقة الشفافة */
        z-index: -1; /* فوق الصورة لكنها تحت المحتوى */
    }

    .coupon-card {
        background-color: rgba(255, 255, 255, 0.85); /* ممكن تضيف شفافية للكارت نفسه */
        padding: 20px;
        border-radius: 12px;
      ...
      <div class="col-md-6">
        <div class="coupon-card">
          <h6 class="coupon-title">
            <i class="fa-solid fa-ticket"></i> <?php echo e(__('messagess.discount_coupon')); ?> 
          </h6>
          <p class="coupon-text"><?php echo e($coupon->promotion->description); ?></p>
          <p class="coupon-text discount_code">
            <?php echo e(__('messagess.discount_code')); ?> <?php echo e($coupon->coupon_code); ?>

          </p>
          <div class="coupon-footer">
            <span><?php echo e(__('messagess.valid_until')); ?> <?php echo e($coupon->promotion->end_date_time); ?></span>
            <span class="copy-code" data-code="<?php echo e($coupon->coupon_code); ?>" style="cursor: pointer;">
              <?php echo e(__('messagess.copy_code')); ?> <i class="fa-regular fa-copy"></i>
            </span>
          </div>
        </div>
      </div>
  ...
  copyButtons.forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      navigator.clipboard.writeText(code).then(() => {
        createNotify({
          title: '<?php echo e(__("messagess.copy_code")); ?>',
          desc: '<?php echo e(app()->getLocale() == "ar" ? "تم نسخ الكود بنجاح!" : "Code copied successfully!"); ?>'
        });
      }).catch(err => {
...
</html><?php /**PATH C:\Users\VIP\Desktop\jospa.v.4\jospa_web-new\resources\views/components/frontend/auth/coupon.blade.php ENDPATH**/ ?>